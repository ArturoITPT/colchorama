...
class Returns extends super_controller{
    
    private $view = "list";
    private $id = null;
    private $dir = 'operator';
    private $controller='returns';
    private $Model = 'Returned';
    protected $title = "Motivos de Devolución";
    private $add_label = "Agregar Motivo de Devolución";
