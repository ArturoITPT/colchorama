...
//echo "here";
class Depots extends super_controller{
    
    private $view = "list";
    private $id = null;
    private $dir = 'operator';
    private $controller='depots';
    private $Model = 'Depot';
    protected $title = "Bodegas";
    private $add_label = "Agregar Bodega";
    ...
    function formContent(){
        ...
        $formGroup = $this->FormGroup();     
            ...
            $options = $record->getBranchesOptions();
            $selected = $record->getSelectedBranches();
            
            $multiselect = new Multiselect("branches[]",$options,$selected);
            $multiselect->setClass("form-control multi");
            $multiselect->setAttr("multiple","multiple");
            
            $label = $this->Label("Surte a Sucursales");
            $inputWrapper = $this->Input($multiselect);
        $formGroup->add($label);
        $formGroup->add($inputWrapper);
    ...
    function save(){
        ...
        $children = $this->input->post("branches");
   ...
   function entable($all){
        ...
        foreach ($all as $key=> $patient){
             $tr = new Tr();
                 ...
                 $td = new Td($patient->getBranchesTable());
                 $tr->add($td);   
