...
class Employees extends super_controller{
    
    private $view = "list";
    private $id = null;
    private $dir = 'operator';
    private $controller='employees';
    private $Model = 'Employee';
    protected $title = "Empleados";
    private $add_label = "Agregar Empleado";
    ...
    function formContent(){
        ...
        $label = "Puesto";
        $input = new Input("job_title",$record->job_title,'text','form-control');
        $input->setAttr("required","required");
        $element = $this->FormElement($label,$input);     
        $form->add($element);
       
        $label = "Email";
        $input = new Input("email",$record->email,'text','form-control');
        $input->setAttr("required","required");
        $element = $this->FormElement($label,$input);     
        $form->add($element);
        
        $label = "Usuario";
        $input = new Input("user_name",$record->user_name,'text','form-control');
        $input->setAttr("required","required");
        $element = $this->FormElement($label,$input);     
        $form->add($element);
        ...
        $options = $record->showBranches();
        $select = new Multiselect("branch_id",$options,array($record->branch_id));
