...
class Unitsofmeasures extends super_controller{
    
    private $view = "list";
    private $id = null;
    private $dir = 'operator';
    private $controller='unitsofmeasures';
    private $Model = 'Unitsofmeasure';
    protected $title = "Unidades de Medida";
    private $add_label = "Agregar Unidad de Medida";
    ...
    function formContent(){
        ...
        $input = new Textarea("description",$record->description);
        $input->setAttr("required","required");
