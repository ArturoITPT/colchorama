...
class Taxes extends super_controller{
    
    private $view = "list";
    private $id = null;
    private $dir = 'operator';
    private $controller='taxes';
    private $Model = 'Tax';
    protected $title = "Impuestos";
    private $add_label = "Agregar Impuesto";
    ...
    function formContent(){
        ...
        $label = "Porcentaje";
        $input = new Input("percent",$record->percent,'number','form-control');
        $input->setAttr("required","required");
