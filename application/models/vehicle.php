...
//                ////
        ...
        //var_dump($this->polizavence);      
        if ($this->polizavence==NULL){
            $this->polizavence = date("Y-m-d");
        }    
   ...
   function getVehicleTypes(){
       ...
       $all = $types->get()->all;
       return $this->toIdNameAssoc($all);
   }
   
   function getVehicleTypeSelected(){
       
       $result = array();
       //echo ($this->vehicletype_id);;
       $types= new Vehicletype($this->vehicletype_id);
       $all = $types->all;
       //echo "son ".count($all);
       //p($all);
   ...
   function getSelectedDriver(){
       ...
       $result = array();
       //echo ($this->vehicletype_id);;
       $types= new Employee($this->employee_id);
       $all = $types->all;
       //echo "son ".count($all);
       //p($all);
    ...
    function getAllVerifications(){
       ...
       $types= new Verificationtype();
       $all = $types->get()->all;
       return $this->toIdNameAssoc($all);
   }
   
   function getSelectedVerification(){
       
       $result = array();
       //echo ($this->vehicletype_id);;
       $types= new Verificationtype($this->verificationtype_id);
       $all = $types->all;
       //echo "son ".count($all);
       //p($all);
